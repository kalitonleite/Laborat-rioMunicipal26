          ...
          <div className="md:w-1/3 flex flex-col">
            <div className="flex justify-between items-start mb-10">
              ...
              <div className="bg-white rounded-2xl shadow-xl border border-emerald-50 overflow-hidden w-32 h-32">
                <img src={appLogo || "/assets/logo-uarini.jpg"} alt="Logo" className="w-full h-full object-cover scale-[1.2]" />
              </div>
            </div>
            ...
            <div className="mt-auto bg-emerald-50 p-6 rounded-[32px] border border-emerald-100 relative overflow-hidden">
              ...
              <p className="text-[11px] text-emerald-900/70 leading-relaxed font-semibold">
          ...
          <div className="md:w-2/3">
            <form onSubmit={handleRegister} className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative group">
                  <i className="fas fa-phone absolute left-5 top-1/2 -translate-y-1/2 text-slate-300 group-focus-within:text-emerald-600 transition-colors"></i>
                  <input
